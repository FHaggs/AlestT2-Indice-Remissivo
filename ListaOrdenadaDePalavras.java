...
public class ListaOrdenadaDePalavras {
    ...
    public int[] paginaComplexa() {

        Map<Integer, Integer> pages = new HashMap<>();

        Palavra palavra = header.next;

        while (palavra != trailer) {
            Iterator<Integer> iterator = palavra.listaOcorrencias.iterator();
        ...
        int[] rValues = {maxPage, maxOccurrences};
        return rValues;
